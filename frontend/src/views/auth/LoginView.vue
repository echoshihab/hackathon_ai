  ...
  <div class="min-h-screen bg-red-50 flex items-center justify-center px-4">
    <div class="bg-white rounded-2xl shadow-lg p-8 w-full max-w-sm">
      <div class="text-center mb-6">
        ...
        <p class="text-sm text-gray-500 mt-1">Your Health After a Heart Attack</p>
      </div>
      ...
      <p class="text-center text-sm text-gray-500 mt-4">
        ...
        <RouterLink to="/register" class="text-red-600 font-medium hover:underline">Register</RouterLink>
      </p>
    </div>
  </div>
</template>
